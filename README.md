...
``` bash
git clone https://github.com/Erebus54/Ottawa-Covid19-Tracker-Dashboard.git
```

Website
-------

The app is currently deployed here: <https://patrickschnurbusch.shinyapps.io/OttawaTracker/>
